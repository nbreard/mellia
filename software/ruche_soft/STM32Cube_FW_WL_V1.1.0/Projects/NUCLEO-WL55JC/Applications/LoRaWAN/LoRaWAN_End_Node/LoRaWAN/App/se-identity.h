 ...
 */
#define LORAWAN_DEVICE_EUI                                { 0x00, 0x80, 0xE1, 0x15, 0x00, 0x07, 0x51, 0xF8 }  
...
#define LORAWAN_DEVICE_ADDRESS				     ( uint32_t )0x260B41D2
 ...
 * Network root key
 */
#define LORAWAN_NWK_KEY                                  70,C5,BF,84,8D,58,50,16,15,CF,1F,2C,12,35,F1,8E
 ...
 */
#define LORAWAN_APP_S_KEY                                  2F,00,45,4C,23,31,22,C6,2D,05,68,9A,15,10,1A,4B
